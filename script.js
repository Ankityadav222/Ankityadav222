    ...
    return(
        <div className="card">
            ...
            <img src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660"+
              RestaurentList.data?.cloudinaryImageId
            } />
            <h4>{RestaurentList.data?.name}</h4>
            <h3>{RestaurentList.data?.cuisines. join(",")}</h3>
            <h4>{RestaurentList.data.lastMileTravelString} minutes</h4>
        </div>
    )
}
